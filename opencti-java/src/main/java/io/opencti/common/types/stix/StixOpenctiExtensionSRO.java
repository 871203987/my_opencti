...
/**
 * STIX OpenCTI Extension for SRO.
 */
public record StixOpenctiExtensionSRO(
    ...
    public StixOpenctiExtensionSRO {
        extensionType = StixExtensionConstants.EXTENSION_TYPE_NEW_SRO;
    }
}
